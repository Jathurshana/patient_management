...
// Store selected values in session if the form is submitted
...
/* Additional styles for date input to handle browser-specific appearance */
...
<body>
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <button type="button" onclick="goTo('staff_menu.php')" style="background-color: #f44336; color: #fff; padding: 10px 20px; font-size: 1.2em; cursor: pointer; margin-top: 10px;">Back</button>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($dataResult === false) {
            die("Error executing query: " . $mysqli->error . " | Query: $dataQuery");
        }
        ...
        if ($dataResult->num_rows > 0) {
            ...
            while ($dataRow = $dataResult->fetch_assoc()) {
                ...
                echo "<td>" . $dataRow['additional_info'] . "</td>";
                echo "<td>";
                echo "<a href='#' onclick='openModal(\"photos/" . $dataRow['file_path'] . "\")'>";
                echo "<img src='photos/" . $dataRow['file_path'] . "' alt='Patient Photo' style='max-width: 100px; max-height: 100px;'>";
                echo "</a>";
                echo "</td>";
